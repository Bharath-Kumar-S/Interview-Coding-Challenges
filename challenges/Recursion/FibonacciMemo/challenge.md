You are given a number n. Write a function that accepts this number as an argument and utilizes recursion to find the Fibonacci number at the index n. Your solution should have a complexity of
O
(
n
)
